...
<meta charset="utf-8">
<title>Consulta de Atividades - System Crown</title>
</head>
<body>
	<?php include("topo.php");?>
	<div class="container">
		<form name="frmConsulta" method="post" action="consanalise.php">
			<p style="width:100%">Selecione o projeto</p>
			...
			<p style="width:100%">Selecione o cargo</p>
		...
		<?php
			if(isset($_POST["sltProjeto"]) && isset($_POST["sltCargo"])){
				echo '<p style="width:100%;text-align:center; margin-top:1vw">Resultado da busca do projeto: '.$proj.'</p>';
				if ($numero > 0) {
				...
				// enquanto houver linhas criar um vetor chamado $dados
					while($dados = mysqli_fetch_array($consulta)){
						...
						echo '<td>'.$novapri.'</td>';
						echo '<td><a href="deletademanda.php?cod='.$dados["cd_atividade"].'&cod2='.$dados["cd_consultor"].'&cod3='.$dados["cd_Contrato"].'" title="Excluir"><img src=imagens/delete.png></a></td>';
						echo '<td><a href="editademanda.php?cod='.$dados["cd_atividade"].'&cod2='.$dados["cd_consultor"].'&cod3='.$dados["cd_Contrato"].'" title="Editar"><img src=imagens/edit.png></a></td>';
		...
		//Caso o numero de linhas for 0 exibir a sseguinte mensagem
				...
				echo '<p style="width:100%; text-align:center">Nenhum resultado para pesquisa.</p>';
			}
		}
		else{
			$proj = "";
