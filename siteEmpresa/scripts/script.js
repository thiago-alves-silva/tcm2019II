...
function menuBar(){
    ...
    if(window.pageYOffset>=(height[0].offsetTop + height[0].clientHeight)){
        ...
        if(a >=height[1].offsetTop && a <=height[2].offsetTop) li[0].style.color = '#ed145b'
        else li[0].style.color = ''

        if(a >=height[2].offsetTop && a <=height[3].offsetTop) li[1].style.color = '#ed145b'
        else li[1].style.color = ''

        if(a >=height[3].offsetTop && a <=height[4].offsetTop) li[2].style.color = '#ed145b'
        else li[2].style.color = ''

        if(a >=height[4].offsetTop && a <=height[5].offsetTop) li[3].style.color = '#ed145b'
        else li[3].style.color = ''

        if(a >=height[5].offsetTop && a <=height[6].offsetTop) li[4].style.color = '#ed145b'
        else li[4].style.color = ''

        if(a >=(height[6].offsetTop) && a <=(height[6].offsetTop + height[6].clientHeight)) li[5].style.color = '#ed145b'
        else li[5].style.color = ''
    }
    else{
        header.style = 'position: absolute'
        header.style = ''
        document.querySelector('div#cabecalho > h1').style = ''
    }
}
menuBar()
